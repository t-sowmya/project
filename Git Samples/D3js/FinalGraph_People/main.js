(function () {
  ...
  function renderLineCharts(data, container = 'body', config = {}) {
    ...
    const containerWidth = config.width || 740;
    const containerHeight = config.height || 563;
  ...
  d3.csv('./People_Data.csv',(err, data) => {
    ...
    let lineColor = ['#0477AD', '#F78203', '#079E24', '#E62E2A', '#906AC0', '#945450','#DAF7A6','#3933FF'];
